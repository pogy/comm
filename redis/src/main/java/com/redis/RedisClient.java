...
public class RedisClient {
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, "192.168.244.131", 6379);
	}
	...
	private void initialShardedPool() {
		...
		shards.add(new JedisShardInfo("192.168.244.131", 6379, "master"));
	...
	private void StringOperate() {  
        ...
        //jedis具备的操作shardedJedis中也可直接使用，下面测试一些前面没用过的方法
